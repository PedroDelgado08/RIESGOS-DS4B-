...
if st.sidebar.button('CALCULAR RIESGO'):
    ...
    with col1:
        st_echarts(options=pd_options, width="110%", key="pd_gauge")
    with col2:
        st_echarts(options=ead_options, width="110%", key="ead_gauge")
    with col3:
        st_echarts(options=lgd_options, width="110%", key="lgd_gauge")
